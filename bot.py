...
# ─── INSTRUMENTS ───────────────────────────────────────────
INSTRUMENTS = [
    {"id": "XAUUSD", "label": "Gold",    "symbol": "XAU/USD",  "decimals": 2, "sl_dist": 3.5},
    {"id": "NAS100", "label": "Nasdaq",  "symbol": "NDX",      "decimals": 1, "sl_dist": 15.0},
    {"id": "USOUSD", "label": "WTI Oil", "symbol": "WTI/USD",  "decimals": 2, "sl_dist": 0.8},
    {"id": "EURUSD", "label": "EUR/USD", "symbol": "EUR/USD",  "decimals": 5, "sl_dist": 0.0012},
]
...
def get_price(inst):
    """Try TwelveData first, fall back to free sources."""
